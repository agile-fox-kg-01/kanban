  ...
  <div id="content">
    <div class="row justify-content-center wrapper">
      <div class="col-12 content-header">
        ...
        <div v-else>
          <a class="header-right-btn" v-on:click="outGroup()">keluar grup</a>
        </div>
      </div>
      <div class="col-sm-card col-md-card col-lg-card task-list">
        <div class="backlog-header">
          <h4>Back log</h4>
          <a v-on:click="showAddModal('backLog')">
        ...
        <div class="scrollContent">
          <div class="card-content" v-for="task in backLogTasks" :key="task.id">
            <div class="task-item">
              ...
              <div v-if="userData.id === task.UserId">
                <a v-on:click="changeCategory(task.id, 'toDo')" class="right-btn">
      ...
      <div class="col-sm-card col-md-card col-lg-card task-list">
        <div class="todo-header">
          <h4>To-do</h4>
          <a v-on:click="showAddModal('toDo')">
            <i class="fa fa-plus"></i>
          </a>
        </div>
        <div class="scrollContent">
          <div class="card-content" v-for="task in todoTasks" :key="task.id">
            <div class="task-item">
              ...
              <h6 class="font-weight-bold">added by: {{task.User.username}}</h6>
              <div v-if="userData.id === task.UserId">
                <a v-on:click="changeCategory(task.id, 'backLog')" class="left-btn">
                    <i class="fa fa-arrow-left"></i>
                </a>
                <a v-on:click="changeCategory(task.id, 'doing')" class="right-btn">
                    <i class="fa fa-arrow-right"></i>
                </a>
              </div>
            </div>
      ...
      <div class="col-sm-card col-md-card col-lg-card task-list">
        <div class="doing-header">
          <h4>Doing</h4>
          <a v-on:click="showAddModal('doing')">
            <i class="fa fa-plus"></i>
          </a>
        </div>
        <div class="scrollContent">
          <div class="card-content" v-for="task in doingTasks" :key="task.id">
            <div class="task-item">
              ...
              <h6 class="font-weight-bold">added by: {{task.User.username}}</h6>
              <div v-if="userData.id === task.UserId">
                <a v-on:click="changeCategory(task.id, 'toDo')" class="left-btn">
                    <i class="fa fa-arrow-left"></i>
                </a>
                <a v-on:click="changeCategory(task.id, 'done')" class="right-btn">
                    <i class="fa fa-arrow-right"></i>
                </a>
              </div>
            </div>
      ...
      <div class="col-sm-card col-md-card col-lg-card task-list">
        <div class="done-header">
          <h4>Done</h4>
          <a v-on:click="showAddModal('done')">
            <i class="fa fa-plus"></i>
          </a>
        </div>
        <div class="scrollContent">
          <div class="card-content" v-for="task in doneTasks" :key="task.id">
            <div class="task-item">
              ...
              <h6 class="font-weight-bold">added by: {{task.User.username}}</h6>
              <div v-if="userData.id === task.UserId">
                <a v-on:click="changeCategory(task.id, 'doing')" class="left-btn">
                    <i class="fa fa-arrow-left"></i>
                </a>
              </div>
            </div>
    ...
    >
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          ...
          <div v-if="userData.id === selectedTask.UserId" class="modal-footer">
            <button
              type="button"
            ...
            <button
              ...
              v-on:click="deleteTask(selectedTask.id)"
            >Delete</button>
          </div>
        </div>
      </div>
...
export default {
  ...
  methods: {
    deleteGroup() {
      axios({
        method: "delete",
        url: `/group/delete/${this.dataGroup.id}`,
        headers: {
    ...
    outGroup() {
      axios({
        method: "delete",
        url: `/group/out/${this.dataGroup.id}`,
        headers: {
          token: localStorage.getItem("token")
        }
      })
    ...
    readMore(id) {
      axios({
        ...
        .then(res => {
          ...
          this.selectedTask.UserId = res.data.UserId;
        })
        .catch(err => {
    ...
    addTaskForm() {
      axios({
        method: "post",
        url: `/task/add/${this.dataGroup.id}`,
        data: {
        ...
        .then(res => {
          ...
          this.$emit("toContentGroupTask", this.dataGroup.id);
        })
        .catch(err => {
